@if($branch->isNot(auth()->user()))
    @if(! $branch->trashed())
        <a href="#branch-{{ $branch->id }}-delete-model"
           title="@lang('branches.actions.delete')"
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title"
                            id="modal-title-{{ $branch->id }}">@lang('branches.dialogs.delete.title')</h5>
    ...
    @else
        <a href="{{ route('dashboard.branches.restore', $branch) }}"
           title="@lang('branches.actions.restore')"
